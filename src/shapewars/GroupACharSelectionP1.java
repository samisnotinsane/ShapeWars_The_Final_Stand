...
public class GroupACharSelectionP1 extends BasicGameState{
	String mouse = "Mouse pointer coordinates: null";
	Image background;
	
	// class constructor
		public GroupACharSelectionP1(int state) {
			System.out.println("Entered state: 2");
		}
		
		public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
			background = new Image("res/background/groupACharSelectionP1.png");
